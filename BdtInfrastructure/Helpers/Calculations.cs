...
using BdtDomain.Models.Charts;
using BdtDomain.Dtos.Planner;
using Plugin.LocalNotification;

namespace BdtApp.Helpers;
...
public static class Calculations
{
    ...
    public static void SetNotifications(IEnumerable<PlannerDto> weeklyPlans)
    {
        LocalNotificationCenter.Current.Clear();
        var now = DateTime.Now;
        var notificationTime = Setting.UserBasicDetail.NotificationTime;
